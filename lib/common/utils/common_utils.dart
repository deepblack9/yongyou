...
import 'package:yongyou/widget/issue_edit_dIalog.dart';
...
class CommonUtils {
  ...
  static String getUserChartAddress(String userName) {
    return Address.graphicHost +
        APPColors.primaryValueString.replaceAll("#", "") +
        "/" +
        userName;
  }
...
//      }
//    }
//    String appDocPath = appDir.path + "/APPgithubappflutter";
...
//      NavigatorUtils.goAPPWebView(context, url, title);
    } else {
//      NavigatorUtils.goAPPWebView(
//          context,
                  ...
                  child: new Container(
                    ...
                    child: new Column(
                      ...
                      children: <Widget>[
                        new Container(
                            child:
                                SpinKitCubeGrid(color: Color(APPColors.white))),
                        new Container(height: 10.0),
                        new Container(
                            child: new Text(
                                CommonUtils.getLocale(context).loading_text,
                                style: APPConstant.normalTextWhite)),
                      ],
                    ),
                  ),
                ),
