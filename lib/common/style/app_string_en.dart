...
class APPStringEn extends APPStringBase {
  ...
  @override
  String home_sales = "Sales";
  @override
  String home_dispatch = "Dispatch";
  @override
  String home_my = "My";
  @override
  String 	businessType = "Business Type"; /// 业务类型
  @override
  String	typeCode = "Sales Type"; /// 销售类型编码
  @override
  String	custCode = "Cust";	/// 客户编码
  @override
  String	deptCode = "Dept";	/// 部门编码
  @override
  String	inventoryCode = "Inventory";	/// 存货编码
  @override
  String  quantity = "Quantity"; /// 数量
  @override
  String	bgift = "Gift";	/// 是否赠品(0=非赠品;1=赠品)
  @override
  String	rowno = "Row No";	/// 行号
